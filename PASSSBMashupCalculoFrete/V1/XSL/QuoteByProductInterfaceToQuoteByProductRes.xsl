    ...
    <tns:Root-Element>
      ...
      <xsl:for-each select="/ns0:Root-Element/ns0:content/ns0:delivery_options">
        <tns:shippingMethods>
          ...
          <tns:taxcode>
            <xsl:value-of select="/ns0:Root-Element/ns0:content/ns0:id"/>
          </tns:taxcode>
