  ...
  <xsl:template match="/">
    <tns:Root-Element>
      ...
      <tns:authorizationResponse>
        ...
        <tns:responseReason>Authorized</tns:responseReason>
        <tns:responseDescription>safety pay</tns:responseDescription>
        <tns:authorizationCode>1234234234324</tns:authorizationCode>
        <tns:hostTransactionId>0234234234234234234</tns:hostTransactionId>
        <xsl:if test="$bodyRequest/ns1:Root-Element/ns1:transactionId">
          <tns:merchantTransactionId>
            <xsl:value-of select="$bodyRequest/ns1:Root-Element/ns1:transactionId"/>
          </tns:merchantTransactionId>
        </xsl:if>
        <tns:authCode>Autorized</tns:authCode>
        <xsl:if test="$bodyRequest/ns1:Root-Element/ns1:transactionId">
          <tns:transactionId>
            <xsl:value-of select="$bodyRequest/ns1:Root-Element/ns1:transactionId"/>
          </tns:transactionId>
